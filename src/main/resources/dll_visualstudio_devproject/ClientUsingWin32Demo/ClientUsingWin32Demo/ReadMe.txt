========================================================================
    KONSOLENANWENDUNG: ClientUsingWin32Demo-Projektübersicht
========================================================================

Diese ClientUsingWin32Demo-Anwendung wurde vom Anwendungs-Assistenten für Sie erstellt.

Diese Datei bietet eine Übersicht über den Inhalt der einzelnen Dateien, aus
denen Ihre ClientUsingWin32Demo-Anwendung besteht.


ClientUsingWin32Demo.vcxproj
...
ClientUsingWin32Demo.vcxproj.filters
...
StdAfx.h, StdAfx.cpp
    Mit diesen Dateien werden eine vorkompilierte Headerdatei (PCH) mit dem Namen ClientUsingWin32Demo.pch und eine vorkompilierte Typendatei mit dem Namen StdAfx.obj erstellt.
