========================================================================
    DYNAMIC LINK LIBRARY: Win32Demo-Projektübersicht
========================================================================

Diese Win32Demo-DLL wurde vom Anwendungs-Assistenten für Sie erstellt.

Diese Datei bietet eine Übersicht über den Inhalt der einzelnen Dateien, aus
denen Ihre Win32Demo-Anwendung besteht.
...
StdAfx.h, StdAfx.cpp
    Mit diesen Dateien werden eine vorkompilierte Headerdatei (PCH) mit dem Namen Win32Demo.pch und eine vorkompilierte Typendatei mit dem Namen StdAfx.obj erstellt.
